...
// ********************************************************************
//
/// \file field/field02/src/ElectricFieldSetup.cc
/// \brief Implementation of the ElectricFieldSetup class
//
//
//
   ...
   fStepperType(4)    // ClassicalRK4 -- the default stepper
{
  fEMfield = new G4UniformElectricField(
                   G4ThreeVector(0.0,3.0*kilovolt/cm,0.0));
...
void ElectricFieldSetup::UpdateIntegrator()
{
  ...
  // G4cout << "ElectricFieldSetup::UpdateIntegrator> "
...
void ElectricFieldSetup::SetFieldZValue(G4double fieldValue)
{
